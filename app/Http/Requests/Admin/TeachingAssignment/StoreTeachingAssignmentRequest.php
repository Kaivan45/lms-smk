...
class StoreTeachingAssignmentRequest extends FormRequest
{
    ...
    /**
     * Validasi tambahan: kombinasi guru+kelas+mapel+tahun ajaran harus unik,
     * dicek manual di sini (bukan cuma andalkan unique constraint di database)
     * supaya pesan errornya bisa lebih ramah ke pengguna.
     */
